...
<!-- ═══════════════════════════════════════════════════════════════════════════
     ...
     Key principle: There is EXACTLY ONE area that gets updated at a time:
     the current 🔄 IN_PROGRESS phase.
...
**TIP**: Keep this plan synchronized with any native TODO/task entries (e.g., IDE checklists).
1. Update both → Mark status
...
- `plans/[previous_task]/plan.md` - [Brief summary terms]
...
# 2. Type issues before style (catch type errors early)
./bin/mypy.sh
mypy graphistry/
