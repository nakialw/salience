# {{TASK_NAME}} Parallel Implementation Plan
**THIS PLAN FILE**: `plans/{{TASK_SLUG}}/plan.md`
**Created**: {{CREATED_AT}}
...
- Every work item must define owner, review owner, write scope, dependencies, and verification.
...
**Purpose:** Merge same-task outputs, resolve conflicts, and align interfaces.
...
**Depends On:** W3-INT
**Purpose:** Verify that the integrated result satisfies the objective.
